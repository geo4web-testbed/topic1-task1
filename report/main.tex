...
\item Scaffolding step: Based on the information gathered, make and
  assessment of current platforms, libraries and tools that implement
  the requirements.  Try to get overview of what will be their
  strengths and weaknesses in an early stage.
...
\item Filling in the blanks: Not all requirements may be available
  ...
  for these two approaches are very different.

\item Test \& iterate: Once an acceptable platform is assembled.
...
\begin{comment}
RDF JavaScript Libraries Group\footnote{See
